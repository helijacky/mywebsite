    ...
    <div class="container">
    	<div class="d-flex justify-content-center h-100">
    		<div class="card">
              ...
              <div class="input-group form-group">
              <input class="form-control" placeholder="Re-input password" type="password">
              </div>
              <div class="input-group form-group">
              ...
              <button type="button" class="btn btn-outline-warning float-right" data-toggle="modal" data-target="#Submit">
                Submit
              </button>
